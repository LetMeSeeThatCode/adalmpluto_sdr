...
class modes_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "modes_receiver")
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('' if '' else iio.get_pluto_uri(), [True, True], 32000)
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff(0.004, 0.006, 0)
        self.blocks_tagged_file_sink_0 = blocks.tagged_file_sink(gr.sizeof_float*1, samp_rate)
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_float*1, 'packet_len', "")
        ...
        self.connect((self.blocks_complex_to_mag_0, 0), (self.blocks_burst_tagger_0, 0))
        ...
        self.connect((self.blocks_threshold_ff_0, 0), (self.qtgui_time_sink_x_0, 3))
