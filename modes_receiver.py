...
class modes_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.filename = filename = '/home/bri/workspace/mode_s_decode/controlpathsdotcom/raw_adsb_files/adsb_raw_'+samp_rate_string+'Hz_'+timestamp+'_mag_char'
        ...
        self.qtgui_time_sink_x_0_0_0.set_y_axis(-0.00001, 0.02)

        self.qtgui_time_sink_x_0_0_0.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0_0_0.enable_tags(True)
        self.qtgui_time_sink_x_0_0_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 0.02, 0, 0, "")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_KAISER,
                2.5))
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('ip:pluto.local' if 'ip:pluto.local' else iio.get_pluto_uri(), [True, True], 262144)
        ...
        self.blocks_complex_to_mag_0.set_block_alias("mag")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 1000000, 200000, window.WIN_KAISER, 2.5))
    ...
    def set_timestamp(self, timestamp):
        ...
        self.set_filename('/home/bri/workspace/mode_s_decode/controlpathsdotcom/raw_adsb_files/adsb_raw_'+self.samp_rate_string+'Hz_'+self.timestamp+'_mag_char')
